...
module.exports = (robot) ->
  ...
  robot.respond /([a-z0-9\s\-]+) is one of us/i, (msg) ->
    if msg.message.user.name == 'Perry Harlock' || msg.message.user.name == 'Jack Watkins'
      return msg.reply 'Now ' + msg.message.user.name + ', you know you\'re not responsible enough to do that!'
    name = msg.match[1]
